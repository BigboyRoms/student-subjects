...
<?php require_once "connection.php" ?><?php include_once "menu.php"; ?>
    <form action="update-students.php"method="POST">
        ...
        <label name="student_Fname">
            ENTER FIRST NAME:
            <input name="student_Fname"value="<?php echo $_GET['student_Fname']; ?>" type="text">
        </label><br>
        <label >
            ENTER LAST NAME:
            <input name="student_Lname"value="<?php echo $_GET['student_Lname']; ?>" type="text">
        </label><br>
        <div>
    ...
    if($result->num_rows > 0) {
        ...
        <td>
            ...
            <a href="edit.php?id=<?php echo $row['id']; ?>&student_Fname=<?php echo $row['student_Fname']; ?>&student_Lname=<?php echo $row['student_Lname']; ?>&gender=<?php echo $row['gender']; ?>&year_level=<?php echo $row['year_level']; ?>&student_Lname=<?php echo $row['student_Lname']; ?>&course=<?php echo $row['course']; ?>&semester=<?php echo $row['semester']; ?>">Edit</a>
